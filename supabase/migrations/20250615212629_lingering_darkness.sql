/*
  # Fix Badge Duplicates and Clean Up Premium Badges

  1. Database Changes
    - Remove duplicate "Premium Member" and "Premium Plus" badges
    - Remove "Early Supporter" badge completely
    - Add unique constraint to prevent future duplicates
    - Add subscription fields to profiles table
    - Create proper subscription badge tracking

  2. Security
    - Update RLS policies for subscription features
    - Add triggers for automatic badge awarding on subscription changes

  3. Functions
    - Update badge checking function to handle subscription badges
    - Add subscription status change triggers
*/

-- First, clean up any duplicate premium badges using ROW_NUMBER() approach
